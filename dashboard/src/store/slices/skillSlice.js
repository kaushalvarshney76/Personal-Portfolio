...
export const getAllSkills = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://personal-portfolio-kiin.onrender.com/api/v1/skills/getall",
      {
        withCredentials: true,
      }
    );
    // console.log("gett all skills response is : ", response.data.message);
    // console.log("gett all skills response is : ", response.data.data);
    dispatch(skillSlice.actions.getAllSkillsSuccess(response.data.data));
...
export const addNewSkill = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://personal-portfolio-kiin.onrender.com/api/v1/skills/add",
      data,
      {
        withCredentials: true,
...
export const updateSkill = (id, proficiency) => async (dispatch) => {
  ...
  try {
    const response = await axios.patch(
      `https://personal-portfolio-kiin.onrender.com/api/v1/skills/update/skill/${id}`,
      { proficiency },
      {
        withCredentials: true,
    ...
    // console.log("update skills response is : ", response.data.message);
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://personal-portfolio-kiin.onrender.com/api/v1/skills/delete/${id}`,
      {
        withCredentials: true,
      }
    );
    // console.log("delete skills response is : ", response.data.message);
