...
export const login = (email, password) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      "https://personal-portfolio-kiin.onrender.com/api/v1/users/login",
      { email, password },
...
export const getUser = () => async (dispatch) => {
  ...
  try {
    ...
    dispatch(userSlice.actions.loadUserSuccess(data.data));
    dispatch(userSlice.actions.clearAllErrors());
  } catch (error) {
...
export const logout = () => async (dispatch) => {
  try {
    const { data } = await axios.get(
      "https://personal-portfolio-kiin.onrender.com/api/v1/users/logout",
      { withCredentials: true }
    );
    // console.log(data);
  ...
  (oldPassword, newPassword, confirmPassword) => async (dispatch) => {
    ...
    try {
      const { data } = await axios.patch(
        "https://personal-portfolio-kiin.onrender.com/api/v1/users/update/password",
...
export const updateProfile = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.patch(
      "https://personal-portfolio-kiin.onrender.com/api/v1/users/update/profile",
      data,
      {
        withCredentials: true,
