...
export const getAllTimeline = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://personal-portfolio-kiin.onrender.com/api/v1/timeline/getall",
      {
        withCredentials: true,
      }
    );
    // console.log("get all timeline response is: ", response.data.data);
    dispatch(timelineSlice.actions.getAllTimelineSuccess(response.data.data));
...
export const addNewTimeline = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://personal-portfolio-kiin.onrender.com/api/v1/timeline/add",
      data,
      {
        withCredentials: true,
    ...
    // console.log("add new timeline rresponse is: ", response);
    dispatch(
...
export const deleteTimeline = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://personal-portfolio-kiin.onrender.com/api/v1/timeline/delete/${id}`,
      {
        withCredentials: true,
      }
    );
    // console.log("delete timeline response is: ", response);
    dispatch(
