...
export const getAllProjects = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://personal-portfolio-kiin.onrender.com/api/v1/project/get",
      {
        withCredentials: true,
      }
    );
    // console.log("get all project response is : ", response);
    dispatch(projectSlice.actions.getAllProjectsSuccess(response.data.data));
...
export const addNewProject = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://personal-portfolio-kiin.onrender.com/api/v1/project/add",
      data,
      {
        withCredentials: true,
    ...
    // console.log("add new project response is :", response);
...
export const deleteProject = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://personal-portfolio-kiin.onrender.com/api/v1/project/delete/${id}`,
      {
        withCredentials: true,
      }
    );
    // console.log("delete project response is :", response);
...
export const updateProject = (id, newData) => async (dispatch) => {
  ...
  try {
    const response = await axios.patch(
      `https://personal-portfolio-kiin.onrender.com/api/v1/project/update/${id}`,
      newData,
      {
        withCredentials: true,
        headers: { "Content-Type": "multipart/form-data" },
    ...
    // console.log("update project response is :", response.data.message);
